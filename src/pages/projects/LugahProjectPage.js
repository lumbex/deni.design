                ...
                <div className="p-4">
                    <section ref={ bgRef } className="intro w-full px-2 sm:px-2 sm:w-4/5 mx-auto my-0">                        
                        <div className="py-4 flex flex-col md:flex-row text-deniblack">
                            <div className="w-full md:w-1/3">
                                <h1 className="mb-2 sm:mb-4 text-4xl font-extrabold leading-none tracking-tight ">Lugah</h1>
                    ...
                    <div className="md:p-4 w-full px-2 sm:px-0 sm:w-3/5 mx-auto my-0">
                        ...
                        <section ref={mySoluRef} className="story flex flex-col text-deniblack font-base px-2 md:px-8 overflow-x-hidden">
                            ...
                            {/* Empathize */}
                            <h2 ref={ empathizeRef } className="text-3xl mt-4 mb-2 alt-font font-bold">Empathize</h2>    
                            ...
                            <h4 className="text-lg text-[#FB8500] mb-2 font-semibold">Competitive Analysis of nigerian bank chatbots</h4>    
                        ...
                        <section className="story flex flex-col text-deniblack font-base px-2 md:px-8 overflow-x-hidden">
                            ...
                            {/* Define */}
                            <h2 ref={defineRef} className="text-3xl mt-4 mb-4 alt-font font-bold">Define</h2>
