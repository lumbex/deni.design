                ...
                <div className="h-[92vh] px-3 py-4 overflow-y-auto text-left">
                    <ul className="space-y-2 text-left">
                        ...
                        <li>
                            ...
                            <ul className="pl-2 text-gray-500 font-normal font-sm">
                                <li><button onClick={() => { handleClick(uResearchRef) }} className="py-1 pl-4 pr-2 hover:text-gray-400 w-full text-left">Research</button></li>
                        ...
                        <li>
                            ...
                            <ul className="pl-2 text-gray-500 font-normal font-sm">
                                <li><button onClick={() => { handleClick(personaRef) }} className="py-1 pl-4 pr-2 hover:text-gray-400 w-full text-left">Product Planing</button></li>
                        ...
                        <li>
                            ...
                            <ul className="pl-2 text-gray-500 font-normal font-sm">
                                <li><button onClick={() => { handleClick(iDesignRef) }} className="py-1 pl-4 pr-2 hover:text-gray-400 w-full text-left">Sketch</button></li>
                                <li><button onClick={() => { handleClick(pIterationRef) }} className="py-1 pl-4 pr-2 hover:text-gray-400 w-full text-left">Design Decisions</button></li>
                                <li><button onClick={() => { handleClick(hProtoypeRef) }} className="py-1 pl-4 pr-2 hover:text-gray-400 w-full text-left">HiFi Prototype</button></li>
                                <li><button onClick={() => { handleClick(iValidationRef) }} className="py-1 pl-4 pr-2 hover:text-gray-400 w-full text-left">Userbility Testing</button></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul className="pl-2 text-gray-500 font-normal font-sm">
                                <li><button onClick={() => { handleClick(tNotesRef) }} className="py-1 pl-4 pr-2 hover:text-gray-400 w-full text-left">Results and Impact</button></li>
                                <li><button onClick={() => { handleClick(learnedRef) }} className="py-1 pl-4 pr-2 hover:text-gray-400 w-full text-left">Reflection</button></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <div className="md:p-4">
                    ...
                    <section className="overview flex flex-col md:flex-row gap-6 text-deniblack px-2 md:pl-12 md:pr-8">
                        <div className="w-full md:w-1/2 block">
                            ...
                            <p className="text-base mb-4">Bank call centers receive a large daily influx of inquiry calls, queries, transaction requests etc. with a thousand  more customers waiting in line to get a turn to speak to a human agent without knowing when they’ll be next. </p>
                            <p className="text-base mb-8">The scope of this project was to talk to PFAs and identify health challenges we could reimagine a new experience for to create more meaningful experiences for patients. </p>                        
                        </div>
                        <div className="w-full md:w-1/2 block">
                    ...
                    <section ref={mySoluRef} className="story flex flex-col text-deniblack font-base px-2 md:px-8 overflow-x-hidden">
                        {/* Solution */}
                        <h2 className="text-3xl mt-4">The Solution: <span className="font-normal">LugahBot</span></h2>
                        ...
                        <p className="text-base mb-4"> Features include:</p>
                        ...
                        <p className="text-base mb-4">I wanted to take a look at the existing chatbots offered by the banking companies in Nigeria to identify any gaps or shortcomings within these existing applications and areas of improvement I could target in creating a more meaningful experience for customers. </p>
                        <p className="text-base mb-8">I conducted a competitive analysis across 2 different bank chatbots. I identified the strengths and weaknesses of all 3 and identified the key services offered by all chatbots. </p>
                    ...
                    <section className="story flex flex-col text-deniblack font-base px-2 md:px-8 overflow-x-hidden">    
                        <h3 ref={uInterviewRef} className="text-xl font-bold mb-4">Customer Interviews</h3>
                        <p className="text-base mb-8">Target users: banking customers across all age groups</p>
                        <img className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675674772/deni.design/lugah/customer-interview-1_gkq7nw.png" alt="Customer interview" />
                        <img className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675674772/deni.design/lugah/customer-interview-2_wxumth.png" alt="Customer interview 2" />
                        <img className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675674772/deni.design/lugah/customer-interview-3_e7sihw.png" alt="Customer interview 3" />

                        <h3 ref={iStatementRef} className="text-xl font-bold mb-2">Findings and Insights</h3>
                        <p className="text-base mb-4">After speaking to some users and doing my online research, and analyzing the gathered information from the online research and user interviews, to help have a linear direction, I categorized the insights into these 2 categories.</p>
                        
                    </section>

                    <section className="comparison flex flex-col md:flex-row gap-6 text-deniblack px-2 md:pl-12 md:pr-[20%]">
                        <div className="w-full md:w-1/2 block">
                    ...
                    <section className="story flex flex-col text-deniblack font-base px-2 md:px-8 overflow-x-hidden">
                        ...
                        <p className="text-base mb-4">After conducting the research and speaking to some customers, here are some of the key takeaways which will inform my design decisions.</p>
                        ...
                        <h3 ref={personaRef} className="text-xl font-bold mb-2">Product Planning</h3>
                        <p className="text-base mb-8">After analyzing the information gathered from my research and with a clear understanding of the problem we were trying to solve for, I came up with a whiteboard shared with the team and stakeholders. This whiteboard was to help set the product direction, come up with the userflow and enable us have a linear direction as we work on our MVP(minimum viable product).</p>
                        <img className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675674645/deni.design/lugah/l-planning-chatbot_ahacx9.png" alt="Chatbot Planing" />
                        


                        <h3 ref={povRef} className="text-xl font-bold mb-2">Problem Statement</h3>
                        <p className="text-base mb-8">Before brainstorming ideas, what challenge or problem we were solving for</p>
                        <img className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675680996/deni.design/lugah/lugah-problem-pov_iwgcc6.png" alt="POVs" />

                    

                        <h3 ref={bStormingRef} className="text-xl font-bold mb-2">Ideate</h3>
                        <img className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675674644/deni.design/lugah/l-HMWs_sem4c4.png" alt="ideate" />
                        ...
                        <img className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675674645/deni.design/lugah/l-MVP_fffde1.png" alt="POVs" />
                        
                        <p className="text-base mb-2">Features prioritized include </p>
                        ...
                        <h3 ref={sBoardRef} className="text-xl font-bold mb-2">Structuring User Flow</h3>
                        ...
                        <img className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675674644/deni.design/lugah/LUGA_Enterprise_1_levlif.png" alt="user flow" />
                        
                        <img ref={iDesignRef} className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675674646/deni.design/lugah/lugah-sketch_cpbbdz.png" alt="Sketch" />

    
                        {/* The Solution */}
                        <h2 ref={pIterationRef} className="text-3xl mt-4">The Solution</h2>
                        <p className="text-base mb-4">After several meetings and iterations to the flow, I came up with the high fidelity prototype design. I centered my design around simplicity and functionality. My design choices branched out from the main point being:</p>
                        <img className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675682462/deni.design/lugah/solution-quote_igdy4n.png" alt="the solution" />
                        <p className="text-base mb-4">Design decisions made in designing the solution include:</p>
                        <ul className="w-full space-y-1 list-disc list-inside pl-6 md:pl-10 mt2 md:mt-4 mb-8 flex flex-col gap-4">
                        ...
                        <img ref={hProtoypeRef} className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675674643/deni.design/lugah/lugah-onboarding-hifi_ulzhfp.png" alt="Hifi 1" />
                        ...
                        <div className="side-by-side content-center flex flex-col md:flex-row gap-6 md:gap-10 text-deniblack px-2 md:pl-12 md:pr-[20%] mt-8">
                            ...
                            <div className="w-full md:w-1/2 flex flex-col justify-center"> 
                                <div>
                                    ...
                                    <p className="text-base mb-4">Lugahbot onboards customers easily and allows easy upload of all documents required for customers to open an account with a bank.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="side-by-side content-center flex flex-col md:flex-row gap-6 md:gap-10 text-deniblack px-2 md:pl-12 md:pr-[20%] mt-8">
                            ...
                            <div className="w-full md:w-1/2 flex flex-col justify-center"> 
                                <div>
                                    ...
                                    <p className="text-base mb-4">Lugahbot is able to provide customers with answers to any information they require or need clarification on. While also red0recting them to a knowledge base system for more information incase needed.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="side-by-side content-center flex flex-col md:flex-row gap-6 md:gap-10 text-deniblack px-2 md:pl-12 md:pr-[20%] mt-8">
                            ...
                            <div className="w-full md:w-1/2 flex flex-col justify-center"> 
                                <div>
                                    ...
                                    <p className="text-base mb-4">Lugahbot is able to help customers make fast and secure fund transfer to any beneficiary, both new and saved ones.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="side-by-side content-center flex flex-col md:flex-row gap-6 md:gap-10 text-deniblack px-2 md:pl-12 md:pr-[20%] mt-8">
                            ...
                            <div className="w-full md:w-1/2 flex flex-col justify-center"> 
                                <div>
                                    ...
                                    <p className="text-base mb-4">Money matters can require serious planning and this is why LugahBot is also able to help. By answering a few questions, and based on answers provided, LugahBot can act as a financial advisor for customers. Providing them with insights to help better save and plan their funds.</p>
                                </div>
                            </div>
                        </div>
                        

                        <h2 ref={iValidationRef} className="text-3xl mt-4 mb-2">Usability Testing</h2>
                        <p className="text-base mb-4">At the GITEX Expo, I had the application tested by some users and a UX Researcher from a Fintech companies as a potential solution for onboarding older adults on their digital banking app. </p>
                        <p className="text-base mb-4">What worked for them:</p>
                        <ul className="w-full space-y-1 list-disc list-inside pl-6 md:pl-10 mt4 md:mt-8 mb-8 flex flex-col gap-4">
                        ...
                        <p className="text-base mb-4">Improvement opportunities </p>
                        <ul className="w-full space-y-1 list-disc list-inside pl-6 md:pl-10 mt4 md:mt-8 mb-8 flex flex-col gap-4">
                        ...
                        <h2 ref={tNotesRef} className="text-3xl mt-4 mb-2">Result and Impact</h2>
                        ...
                        <img className="my-6 md:mr-[20%]" src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1675559591/deni.design/lugah/ResultNumbers_kfnesd.png" alt="result and impact" />
                                                
                        <h2 ref={learnedRef} className="text-3xl mt-4 mb-2">Reflections</h2>
                        <p className="text-base mb-4">Despite being my first time working on conversation interfaces, I was happy for the opportunity to lead the product direction for such a product that we went on to demo at the Dubai GITEX Expo. Here are some of the learnings I took away from working on this product:</p>
