            ...
            <aside id="default-sidebar" className={ `${showSidebar? "wipe-in-right block": "hidden"} project-sidebar  fixed top-14 left-0 z-20 w-80 h-screen transition-transform -translate-x-full sm:translate-x-0 pl-8`} aria-label="Sidebar">
                <div className="h-[92vh] px-3 py-4 overflow-y-auto text-left">
                    <ul className="space-y-2 text-left">
                        <li>
                            <div className="p-2 text-sm font-normal w-full text-left">
                                Introduction
                            </div>
            ...
            <div className={`p-4 sm:ml-64 transition-all duration-300 ease-wipe-in-rt ${showSidebar? "md:pl-12 sm:ml-64 wipe-in-right": "sm:ml-0"}`}>
                <div className="md:p-4">
                    ...
                    <section ref={ problemRef } className="story flex flex-col text-deniblack font-base px-2 md:px-8">
                        ...
                        <h2 className="text-3xl mt-4 alt-font">The Current Challenge</h2>
                    ...
                    <section ref={mySoluRef} className="story flex flex-col text-deniblack font-base px-2 md:px-8 overflow-x-hidden">
                        {/* Solution */}
                        <h2 className="text-3xl mt-4 alt-font">The Solution: <span className="font-normal">LugahBot</span></h2>
                        ...
                        <h3 ref={uResearchRef} className="text-xl font-bold mb-2 alt-text alt-font">Research</h3>
                    ...
                    <section className="story flex flex-col text-deniblack font-base px-2 md:px-8 overflow-x-hidden">    
                        <h3 ref={uInterviewRef} className="text-xl font-bold mb-4 alt-font mt-8">Customer Interviews</h3>
                        ...
                        <h3 ref={iStatementRef} className="text-xl font-bold mt-4 mb-2 alt-font">Findings and Insights</h3>
