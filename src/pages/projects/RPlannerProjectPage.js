            ...
            <div className={`p-4 sm:ml-64 transition-all duration-300 ease-wipe-in-rt ${showSidebar? "md:pl-12 sm:ml-64 wipe-in-right": "sm:ml-0"}`}>
                <div className="md:p-4">
                    ...
                    <section ref={ problemRef } className="story flex flex-col text-deniblack font-base px-2 md:px-8">
                        ...
                        <h2 className="text-3xl mt-4 font-bold">Design Challenge</h2>
                        <h2 className="text-3xl mt-4font-bold">The Solution: <span className="font-normal">R-planner</span></h2>
                    ...
                    <section ref={mySoluRef} className="story flex flex-col text-deniblack font-base px-2 md:px-8 overflow-x-hidden">
                        ...
                        {/* Empathize */}
                        <h2 className="text-3xl mt-4">Empathize</h2>
                        ...
                        <h4 className="text-xl text-blue-600 mb-0">Interviewee 1: Dr Akintide</h4>    
                        ...
                        <div className={`block h-fit transition-all duration-300 ease-wipe-in-rt ${viewMore? "block" : "hidden"}`}>
                            <h4 className="text-xl text-blue-600 mb-0 mt-4">Interviewee 2: Philip Usman</h4>    
                            <ol class="w-full space-y-1 list-decimal list-inside pl-2 mb-2 flex flex-col gap-2">
                                <li>Tell me a little about your background and work history. 
                                    <ol class="w-full space-y-1 list-[lower-alpha] list-inside pl-4 flex flex-col gap-1 mt-1">
                            ...
                            <h4 className="text-xl text-blue-600 mb-0 mt-4">Interviewee 3: Eng. Jay</h4>    
                            <ol class="w-full space-y-1 list-decimal list-inside pl-2 mb-2 flex flex-col gap-2">
                        ...
                        <h4 className="text-xl text-blue-600 mb-0 mt-4">Key takeaways from interviews</h4>    
                        ...
                        <h2 ref={rExperienceRef} className="text-3xl mt-2">Prototyping</h2>
                        ...
                        <h2 className="text-2xl font-bold mt-4">Storyboard</h2>
                        ...
                        <h4 className="text-xl text-blue-600 mb-1">1. Mentor-Skill Sharing App/Platform:</h4>
                        ...
                        <h4 className="text-xl text-blue-600 mb-1">2. Retirement Planner</h4>
                        <p className="text-base mb-2">Explored this design solution as an option based on insights discovered during interviews with all users.</p>
...
I like that the platform is also a way to help professionals give back and share their experiences to train younger people.</p>
                        ...
                        <h3 ref={reflectionRef} className="text-xl font-bold text-blue-600 mb-0">Reflection</h3>
