                ...
                <div className="p-4">
                    ...
                    <div className="md:p-4 w-full px-2 sm:px-0 sm:w-3/5 mx-auto my-0">
                        ...
                        <section className="story flex flex-col text-deniblack font-base py-4 px-2 md:px-8 overflow-x-hidden">
                            ...
                            <h2 ref={dProcessRef} className="text-xl mt-4 mb-2 font-semibold">Definition</h2>
                            ...
                            {/* Empathize */}
                            <h2 ref={uInterviewRef} className="text-3xl mt-4 mb-2 alt-font font-bold">Empathy: Persona</h2>    
                            ...
                            <h2 className="text-3xl mt-4 mb-2 alt-font font-bold">Storyboard</h2>    
                            ...
                            <h2 ref={iStatementRef} className="text-3xl mt-4 mb-2 alt-font font-bold">Design Exploration</h2> 
                        ...
                        <section className="story flex flex-col text-deniblack font-base px-2 md:px-8 overflow-x-hidden">    
                            ...
                            {/* User flow */}
                            <h2 ref={uFlowRef} className="text-3xl mt-4 mb-2 alt-font font-bold">User flow</h2>
                            ...
                            <h2 ref={lofiRef} className="text-3xl mt-4 mb-4 alt-font font-bold">Prototype</h2>
